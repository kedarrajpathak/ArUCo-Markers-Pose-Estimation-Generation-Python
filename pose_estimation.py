...
def pose_esitmation(frame, aruco_dict_type, marker_length, matrix_coefficients, distortion_coefficients):
    ...
    if len(corners) > 0:
        for i in range(0, len(ids)):
            ...
            # Draw Axis
            cv2.drawFrameAxes(frame, matrix_coefficients, distortion_coefficients, rvec, tvec, marker_length*2)  
...
if __name__ == '__main__':
    ...
    while True:
        ...
        output = pose_esitmation(frame, aruco_dict_type, marker_length, k, d)
